 ...
 */
PlaceFacilityState::PlaceFacilityState(Base *base, RuleBaseFacility *rule, State *state, int viewCameraPosX, int viewCameraPosY) : _base(base), _rule(rule), _state(state)
{
	_screen = false;
	...
	_view = new BaseView(_game, this, (BaseViewClickHandler)&PlaceFacilityState::viewLeftClick, 0, Options::infiniteBaseSizes, 192, 192, 0, 8);
