 ...
 */
SelectStartFacilityState::SelectStartFacilityState(Base *base, State *state, Globe *globe) : BuildFacilitiesState(base, state, 0, 0), _globe(globe)
{
...
{
	_game->pushState(new PlaceStartFacilityState(_base, this, _facilities[_lstFacilities->getSelectedRow()], _view->getCameraPosX(), _view->getCameraPosY()));
}
