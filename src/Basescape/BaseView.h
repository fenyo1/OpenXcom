...
public:
	...
	BaseView(Game *game, State *state, BaseViewClickHandler leftClickHandler, BaseViewClickHandler rightClickHandler, bool showExtraSpace, int width, int height, int x = 0, int y = 0);
